		...
		value: function render() {
			...
			return React.createElement(
				...
				React.createElement(
						...
						React.createElement(
							...
							React.createElement(
								...
								portfolio.map(function (stock, index) {
									...
									var cost = shares_owned * cost_per_share;
					...
					React.createElement(
						'form',
						{ className: 'col-12 mt-2', onSubmit: this.addStock },
						React.createElement(
							'div',
